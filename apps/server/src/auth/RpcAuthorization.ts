...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.serverGetCodexLedgerSummary]: AuthOrchestrationReadScope,
  [WS_METHODS.serverListCodexLedgerTurns]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetCodexLedgerTurn]: AuthOrchestrationReadScope,
  [WS_METHODS.serverListCodexLedgerFamily]: AuthOrchestrationReadScope,
  [WS_METHODS.serverExportCodexLedger]: AuthOrchestrationReadScope,
  [WS_METHODS.serverListCodexLedgerQuota]: AuthOrchestrationReadScope,
  [WS_METHODS.serverGetCodexLedgerExperiment]: AuthOrchestrationReadScope,
  [WS_METHODS.serverListCodexLedgerExperiments]: AuthOrchestrationReadScope,
  [WS_METHODS.serverListCodexLedgerRateSnapshots]: AuthOrchestrationReadScope,
  [WS_METHODS.serverCreateCodexLedgerRateSnapshot]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSelectCodexLedgerRateSnapshot]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverSetCodexLedgerCapture]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverUpsertCodexLedgerExperiment]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverUpsertCodexLedgerRun]: AuthOrchestrationOperateScope,
  [WS_METHODS.serverRecordCodexLedgerJevReceipt]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.browserCancelRun]: AuthOrchestrationOperateScope,
