#### [Prompt Caching](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#prompt-caching)

# [What Breaks Caching](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#what-breaks-caching)

Copy for LLM [View as Markdown](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn.md)

[Create API key](https://console.x.ai/team/default/api-keys?utm_source=docs&utm_medium=referral&utm_campaign=developers-advanced-api-usage-prompt-caching-multi-turn&utm_content=article-api-key) [Meet grok-4.7](https://x.ai/news/grok-4-7)
...
## [Cache hit — appending a new message](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#-cache-hit--appending-a-new-message)
...
## [Cache miss — editing an earlier message](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#-cache-miss--editing-an-earlier-message)
...
## [Cache miss — removing a message](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#-cache-miss--removing-a-message)
...
## [Cache miss — reordering messages](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#-cache-miss--reordering-messages)
...
## [Next](https://docs.x.ai/developers/advanced-api-usage/prompt-caching/multi-turn#next)
